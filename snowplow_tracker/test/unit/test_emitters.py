...
class TestEmitters(unittest.TestCase):
    ...
    def test_init(self) -> None:
        e = Emitter("0.0.0.0")
        self.assertEqual(
            e.endpoint, "https://0.0.0.0/com.snowplowanalytics.snowplow/tp2"
        )
    ...
    def test_input_bytes_post(self, mok_flush: Any) -> None:
        ...
        self.assertEqual(
            e.event_store.event_buffer, [{"testString": "test", "testNum": "2.72"}]
        )
    ...
    def test_send_events_get_success(self, mok_http_get: Any) -> None:
        ...
        e = Emitter(
            ...
            method="get",
            batch_size=10,
            on_success=mok_success,
            on_failure=mok_failure,
        )
    ...
    def test_send_events_post_success(self, mok_http_post: Any) -> None:
        ...
        e = Emitter(
            "0.0.0.0", batch_size=10, on_success=mok_success, on_failure=mok_failure
        )
    ...
    def test_async_emitter_input(self, mok_flush: Any) -> None:
        ...
        ae = AsyncEmitter(
            "0.0.0.0", port=9090, method="get", batch_size=3, thread_count=5
        )
    ...
    def test_input_unicode_get(self, mok_flush: Any) -> None:
        ...
        payload = {"unicode": "\u0107", "alsoAscii": "abc"}
