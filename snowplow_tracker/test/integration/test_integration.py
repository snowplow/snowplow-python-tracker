...
def pass_response_content(url, request):
    latest_querystring[0] = request.url
    return {
        "url": request.url,
        "status_code": 200
    }
...
class IntegrationTest(unittest.TestCase):
    ...
    def test_integration_page_view(self):
        ...
        with HTTMock(pass_response_content):
            ...
            self.assertEquals(from_querystring("page", latest_querystring[0]),"Save+The+Arctic")
    ...
    def test_integration_ecommerce_transaction(self):
        ...
        with HTTMock(pass_response_content):
            ...
            for key in assertion_array:
                self.assertEquals(from_querystring(key, latest_querystring[0]), assertion_array[key])
