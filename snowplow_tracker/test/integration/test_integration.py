...
class IntegrationTest(unittest.TestCase):
    ...
    def test_integration_context_non_base64(self):
        t = tracker.Tracker([default_emitter], default_subject, encode_base64=False)
        with HTTMock(pass_response_content):
            t.track_unstruct_event(SelfDescribingJson("iglu:com.acme/viewed_product/jsonschema/2-0-2", {"product_id": "ASO01043", "price$flt": 49.95, "walrus$tms": 1000}), context=[SelfDescribingJson("iglu:com.example/user/jsonschema/2-0-3", {"user_type": "tester"})])
    ...
    def test_timestamps(self):
        ...
        with HTTMock(pass_post_response_content):
            with freeze_time("2013-01-14 03:21:34"):
                t.track_struct_event("Test", "A", tstamp=None)
                t.track_struct_event("Test", "B", tstamp=1358933694000)
            with freeze_time("2013-01-14 03:22:36"):
                t.track_struct_event("Test", "C", tstamp=DeviceTimestamp(1458133694000))
                t.track_struct_event("Test", "D", tstamp=TrueTimestamp(1458033694000))
